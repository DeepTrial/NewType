/* Copyright 2023 The NT_Integer Authors
...
#ifndef NT_DTYPES_INTN_H_
#define NT_DTYPES_INTN_H_
...
private:
    ...
    static inline constexpr UnderlyingTy Mask(UnderlyingTy v)
    {
        return static_cast<UnsignedUnderlyingTy>(
                   static_cast<UnsignedUnderlyingTy>(v)
                   << (kUnderlyingBits - N)) >>
               (kUnderlyingBits - N);
    }
...
template <>
struct numeric_limits<NT_Integer::int1>
    : public NT_Integer::internal::intN_numeric_limits_base<NT_Integer::int1> {
};
template <>
struct numeric_limits<NT_Integer::uint1>
    : public NT_Integer::internal::intN_numeric_limits_base<NT_Integer::uint1> {
};
template <>
struct numeric_limits<NT_Integer::int2>
    : public NT_Integer::internal::intN_numeric_limits_base<NT_Integer::int2> {
};
template <>
struct numeric_limits<NT_Integer::uint2>
    : public NT_Integer::internal::intN_numeric_limits_base<NT_Integer::uint2> {
};
template <>
struct numeric_limits<NT_Integer::int4>
    : public NT_Integer::internal::intN_numeric_limits_base<NT_Integer::int4> {
};
template <>
struct numeric_limits<NT_Integer::uint4>
    : public NT_Integer::internal::intN_numeric_limits_base<NT_Integer::uint4> {
};

}  // namespace std

#endif  // NT_DTYPES_INTN_H_